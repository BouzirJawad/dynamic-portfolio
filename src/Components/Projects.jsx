...
function Projects() {
    ...
    return(
        <section className="w-[80%] sm:w-[70%] md:w-[55%] lg:w-[65%] mx-auto mt-2 md:mt-10">
            ...
            <div className="grid lg:grid-cols-2 lg:gap-5">
                ...
                <div className={`transition-all duration-700 ease-out overflow-hidden ${isOpen ? "max-h-[1000px] opacity-100" : "max-h-0 opacity-0"}`}>
                    <Card img={startUp} alt="startUp picture" title="StartUp website" desc="a website application that showcase my group members skills/services."/>
                </div>

                <div className={`transition-all duration-700 ease-out overflow-hidden ${isOpen ? "max-h-[1000px] opacity-100" : "max-h-0 opacity-0"}`}>
                    <Card img={weather} alt="Weather app picture" title="Weather app website" desc="a website application that displays the current weather of cities."/>
                </div>
            </div>
